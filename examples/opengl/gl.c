...
void init_gl(gl_ctx *ctx, int w, int h) {
  ...
  ctx->window =
      SDL_CreateWindow("OpenHMD opengl example", SDL_WINDOWPOS_UNDEFINED,
...
void create_fbo(int eye_width, int eye_height, GLuint *fbo, GLuint *color_tex,
                GLuint *depth_tex) {
  ...
  glTexImage2D(GL_TEXTURE_2D, 0, GL_DEPTH_COMPONENT24, eye_width, eye_height, 0,
